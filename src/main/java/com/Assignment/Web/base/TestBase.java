package com.Assignment.Web.base;
...
import com.Assignment.Web.ObjectRepo.*;
...
public class TestBase{
    ...
    public TestBase() {
        try {
            prop = new Properties();
            FileInputStream inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/main/java/com/Assignment/web/config/config.properties");
    ...
    private static void webSetup() throws MalformedURLException {
		...
		PageFactory.initElements(driver, blazedemoPages_OR.class);
