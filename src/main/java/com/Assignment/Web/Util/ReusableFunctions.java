...
//                action.click();
    ...
    public static String takeScreenShot(String screenshotName) {
        ...
        try{
            ...
            logger.info("Saving screenshot to fail repo: " + destination);
    ...
    public static String takeScreenShotPass(String screenshotName) {
        String destination = null;
        try{
            String dateName = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
            TakesScreenshot ts = (TakesScreenshot) driver;
            ...
            destination = finalDestination.getAbsolutePath();
            logger.info("Saving screenshot to pass repo: " + destination);
    ...
    public static String FullPagetakeScreenShot(String screenshotName) {
        String destination = null;
        try{
